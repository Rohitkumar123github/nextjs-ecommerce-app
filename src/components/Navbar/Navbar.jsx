"use client"
import { adminNavOptions, navOptions, styles } from '@/utils/data'
...
const NavItems = ()=>{
    return (
        <div className='items-center justify-between w-full md:flex md:w-auto' id='nav-items'>
            <ul className='flex flex-col p-4 md:p-0 mt-4 foont-medium border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white'>
                {
